<?php
/**
 * Product Source Code - Management Dashboard
 * Simple: No variants, No stock management, Just link + stats
 */
...
<div class="page-header"
    ...
    <div>
        <h1 style="margin: 0; color: var(--text-primary); display: flex; align-items: center; gap: 1rem;">
            ...
            Source Code: <?= htmlspecialchars($product['name']) ?>
        </h1>
        <p style="color: var(--text-muted); margin: 0.5rem 0 0 0;">
            ...
            <span class="status-badge" style="margin-left: 0.5rem; background: #3b82f6;">
...
<div class="form-section" style="margin-bottom: 2rem;">
    ...
    <div style="display: grid; grid-template-columns: 300px 1fr; gap: 2rem; padding: 1.5rem;">
            ...
            <div style="margin-top: 1rem;">
                <span
                    ...
                    <?php if ($category): ?>
                        ...
                        if ($iconType === 'image' || preg_match('/\.(jpg|jpeg|png|gif|webp|svg)$/i', $iconValue)): ?>
        ...
        <div style="display: grid; gap: 1rem;">
            ...
            <div>
                <strong style="color: var(--text-primary);"><i class="fas fa-link"></i> Link Download:</strong>
                <div
                    style="background: rgba(30, 41, 59, 0.6); border: 1px solid rgba(59, 130, 246, 0.3); border-radius: 8px; padding: 1rem; margin-top: 0.5rem; font-family: monospace; font-size: 0.9rem;">
